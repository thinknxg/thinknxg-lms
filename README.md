...
thinknxg LMS is an easy-to-use,  learning management system. You can use it to create and share online courses. The app has a clear UI that helps students focus only on what's important and assists in distraction-free learning.
...
thinknxg LMS is built on  which is a batteries-included python web framework.
